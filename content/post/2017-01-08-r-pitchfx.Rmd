...
```{r, echo=-1, cache=TRUE, message=FALSE}
library(pitchRx2)
...
saveGIF({animateFX(pitch, layers = x, point.alpha = 0.5)},
        interval = 1.0, movie.name = paste0(p_name, ".gif"), width = 800)
```

![](https://user-images.githubusercontent.com/6095476/35471220-25426380-039a-11e8-8262-ca441246bcd0.gif)
...
saveGIF({animateFX(pitch_x, layers = x, point.alpha = 0.5)},
        interval = 1.0, movie.name = paste0(p_name, "_x.gif"), width = 800)
```

![](https://user-images.githubusercontent.com/6095476/35471572-fe64431c-03a0-11e8-997c-8e189374d920.gif)
