...
※`{pitchRx}`パッケージの基本的な使い方は[コチラ](https://pitchrx.cpsievert.me/)を参照。現状`{pitchRx2}`パッケージではinning_allデータしか対応していません。(2018年1月28日現在)
...
2014年、2015年はいろんな球種が打たれてますが、2016年、2017年はSinker、Sliderに集中しているようです。


## まとめ
今回は現状把握としてマーくんの球種やコースに着目して集計をしました。2017年のマーくんは不調というよりはMLB全体のバッターレベルの上昇が影響していて、マーくんの球質と上手く噛み合ってしまったことが原因のようです。


次作は球の回転や変化量について深掘りしたいと思います。
